...
class Consumer
{
    private const float DEFAULT_CONSUME_DELAY = 0.050; // ms

    public function __construct(
        private readonly Bus $bus,
        private readonly Serializer $serializer,
        private readonly float|int $consumeDelay = self::DEFAULT_CONSUME_DELAY,
    ) {}

    public function consume(Queue $queue, Cancellation $cancellation): void
    {
        try {
